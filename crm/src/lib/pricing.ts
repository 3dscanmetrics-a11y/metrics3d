export const DEFAULT_PRICING = {
  area_tiers: [
    { max_area: 200 as number | null, rate: 18.0 },
...
export function formatZAR(val: number) {
...
function pickAccessMult(config: PricingConfig, access?: string) {
...
function pickAccuracyMult(config: PricingConfig, accuracy?: string) {
...
function pickLodMult(config: PricingConfig, bimLevel?: string) {
...
function baseRateForArea(config: PricingConfig, area: number) {
...
export function calculateEstimateRange(config: PricingConfig, input: QuoteInput) {
